...
from . hospital_filters import NairobiHealthFacilitiesFilters
...
class NairobiHealthFacilitiesViewset(viewsets.ModelViewSet):
    ...
    filterset_class = NairobiHealthFacilitiesFilters
    ...
    def get_nearest_facilities(self, request):
        ...
        if x_coords and y_coords:
            ...
            nearest_five_facilities = NairobiHealthFacilities.objects.annotate(distance=Distance('geom', user_location)).order_by('distance')[:5]
